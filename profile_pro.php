...
if(isset($_POST['form_user']) && !empty($_POST['form_user']) && $_POST['form_user'] == 'update_user'){
	...
	Idao::redirect('profile_pro.php?id='.$id_user.'&rep=1');
}
...
if(isset($_POST['form_produit']) && !empty($_POST['form_produit']) && $_POST['form_produit'] == 'update_produit'){
	...
	if(isset($_POST['form_upd'])){
		...
		Idao::redirect('profile_pro.php?rep=1');
	}
									...
									<table style="width:100%">
										...
										<tbody>
											<tr>
												...
												<td> 
													<button name="form_upd" class="btn sm btn-warning" type="submit">Modifier</button>
													<a onclick="return confirm('voulez vous vraiement supprimer cet element?')" href="models/produit/controller.php?action=deletepro&id_produit=<?= $d->id_produit ?>" class="btn sm btn-danger">Supprimer</a>													
												</td>
											</tr>
										</tbody>
									</table>
						 ...
						 <input type="hidden" name="form_user" value="update_user"/>
                          <div class="form-row">
                            <div class="form-group col-md-6">
                              <input type="text" name="nom" value="<?= $u->nom ?>" class="form-control"  placeholder="Nom de votre commerce"/>
                            </div>
                            <div class="form-group col-md-6">
                              <input type="text" name="specialite" value="<?= $u->specialite ?>" class="form-control" placeholder="Specialite"/>
                            </div>
                          </div>
                          <div class="form-row">
                            <div class="form-group col-md-6">
