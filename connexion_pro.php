...
?>
    <div class="container" id="lien-page">
        <p><a href="index.php" class="text-decoration-none text-secondary">Accueil</a> > Connexion particulier</p>
    </div>
    <!-- Contact Start  -->
        ...
        <div class="container">
            <div class="row">
                    ...
                    <form action="" method="POST" class="shadow pl-3 pr-3 pt-5 pb-5">
                        ...
                        <div class="form-group">
                            <div class="container-fluid" id="container-1">
                                <div class="row">
                                    <div class="col-md-6">
                                        <label for="Reste_connecté"><input id="Reste_connecté" type="checkbox"><span class="ml-2">Reste connecté</span></label>
                                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <p class="mt-5">Créez votre compte professionel en quelques clics ! Vous pouvez vous inscrire en utilisant votre adresse e-mail.</p>
                    <div class="mt-5">
                        <button onclick="window.location.href ='creation_compte_pro.php'" class="btn-block">CREER VOTRE COMPTE</button>
                    </div>
                </div>
            </div>
        </div>
