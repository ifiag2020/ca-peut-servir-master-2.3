      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
			...
			<!-- Form -->
            <form action="models/user/controller.php?action=<?= $action ?>" method="POST">
				<?php
                    if (isset($user)) {
                ?>
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  <input value="<?= (isset($user)) ? $user->nom : '' ?>" type="text" class="form-control p-4" placeholder="Nom de votre commerce" id="nom" name="nom" />
                 </div>
                <div class="form-group col-md-6">
                  <input value="<?= (isset($user)) ? $user->specialite : '' ?>" type="text"  class="form-control p-4" placeholder="Spécialité" id="specialite" name="specialite" />
                </div>
              </div>
              <div class="form-row">
                <div class="form-group col-md-6">
                  <input value="<?= (isset($user)) ? $user->email : '' ?>" type="email" class="form-control p-4" placeholder="Adresse e-mail" id="email" name="email"/>
                </div>
                <div class="form-group col-md-6">
                  <input value="<?= (isset($user)) ? $user->pwd : '' ?>" type="password"  class="form-control p-4" placeholder="Mot de passe" id="pwd" name="pwd" />
                </div>
              </div>
              <div class="form-row">
                <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                  <input value="<?= (isset($user)) ? $user->telephone : '' ?>" type="tel" class="form-control p-4"  placeholder="Téléphone" id="telephone" name="telephone" />
                </div>
              </div>
			...
			<input type="hidden" name="id_profile" id="id_profile" value="3">
              <div class="form-group">
              ...
              <div class="text-center mb-4">
                Vous possédez déjà un compte professionel ?
              </div>
